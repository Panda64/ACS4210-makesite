...
[![Go Report Card](https://goreportcard.com/badge/github.com/YOUR_USERNAME/YOUR_REPONAME)](https://goreportcard.com/report/github.com/Panda64/ACS4210-makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
  ...
  - [x] **_FILL IN THE BLANK_**: `I will use the go-colortext library. The documentation is located at https://pkg.go.dev/github.com/daviddengcn/go-colortext#section-readme. My goal is to use it to make the terminal output more human-friendly.`
- [x] **Add, commit, and push to GitHub**.
